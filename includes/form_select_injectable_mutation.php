...
?>
<div class="select_injectable_mutation indent">
	<form class="form_select_injectable_mutation">
	...
	<div class="injectable_mutation_details"></div>
	<button class="button_injectable_mutation_details add_new">Add Details</button>
</div>